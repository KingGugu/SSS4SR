...
def parse_args():
    ...
    # -------------------------
    parser.add_argument("--augment_type", default='prefix', type=str)
    parser.add_argument("--slide_window_size", default=3, type=int)
    # loss type
    parser.add_argument("--loss_type", type=str, default="BCE", help="loss function type: CE or BCE")
    # ---------------------------------------------------
    ...
    # model args
    parser.add_argument("--model_type", default='Single_Target_Implementation', type=str)
    ...
    parser.add_argument('--model_idx', default=1, type=int, help="models idenfier 10, 20, 30...")
