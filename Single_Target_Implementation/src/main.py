...
def main():
    ...
    args = parse_args()
    args.output_dir = os.path.join(args.output_dir, args.model_type, args.loss_type )
    check_path(args.output_dir)


    log_path = os.path.join(args.output_dir, args.train_name + str(args.model_idx) +'.log')
    ...
    args.checkpoint_path = os.path.join(args.output_dir, args.train_name + str(args.model_idx) + '.pt')
